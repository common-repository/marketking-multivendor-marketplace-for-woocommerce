                                                ...
                                                <div class="data-col" >
                                                    ...
                                                    <span class="data-value">
                                                        <img class="marketking_profile_images_preview" src="<?php 
                                                            ...
                                                            $imageprof = marketking()->get_store_profile_image_link($user_id);
                                                ...
                                                <div class="data-col" >
                                                    ...
                                                    <span class="data-value">
                                                        <img class="marketking_profile_images_preview" src="<?php 
                                                            ...
                                                            $imageprof = marketking()->get_store_banner_image_link($user_id);
                                                        ...
                                                        <div class="row gy-4">
                                                            ...
                                                            <div class="col-12">
                                                                <ul class="flex-wrap flex-sm-nowrap gx-4 gy-2">
                                                                    <li>
                                                                        <input type="hidden" id="marketking_profile_logo_image" name="marketking_profile_logo_image" value="<?php 

                                                                        $profile = marketking()->get_store_profile_image_link($user_id);

                                                                        echo esc_attr($profile);

                                                                    ?>">
                                                                        <input type="hidden" id="marketking_profile_logo_image_banner" name="marketking_profile_logo_image_banner" value="<?php 
